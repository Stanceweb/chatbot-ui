...
AS $$
DECLARE
  project_url TEXT := 'https://ptdkkvrhdiftvpslpwgc.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB0ZGtrdnJoZGlmdHZwc2xwd2djIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2Mjg4OTExNCwiZXhwIjoyMDc4NDY1MTE0fQ.G8ZRpRoj-ZUimrkjMucJsW_FHcuMud3aWNFWSCqa-MA'; -- full access needed for http request to storage
